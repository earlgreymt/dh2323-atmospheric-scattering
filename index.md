...
We varied the scale height, atmosphere shell thickness, and ray march 
step count. The scale height one was particularly interesting. A very 
small value gives the planet a razor thin sharp halo, while a large 
value creates a wide soft glow that almost swallows the planet.

The ray march step count experiment also showed a clear quality versus 
speed tradeoff. At 4 steps you can see visible banding in the atmosphere. 
At 16 steps it looks smooth. At 32 steps it looks almost identical to 
16 steps but takes twice as long to render.

<!-- INSERT PARAMETER EXPERIMENT SCREENSHOTS HERE -->
...
![4 ray march steps](screenshots/steps_4.png)
![16 ray march steps](screenshots/steps_16.png)
![32 ray march steps](screenshots/steps_32.png)
...
Final high resolution renders were saved today for the report figures.

<!-- INSERT FINAL HIGH RESOLUTION RENDERS HERE -->
![Final render noon view](screenshots/final_noon.png)
![Final render sunset view](screenshots/final_sunset.png)
